...
void crea_grafo_alternativo(vector<Arco> a[],Nodo *nodi[]){
	Arco a0(nodi[0],nodi[1],1);
	Arco a1(nodi[0],nodi[2],3);
	Arco a2(nodi[0],nodi[3],7);
	
	Arco a3(nodi[1],nodi[2],1);
	Arco a4(nodi[1],nodi[4],7);
	
	Arco a5(nodi[2],nodi[4],2);
	Arco a6(nodi[2],nodi[3],1);

	Arco a7(nodi[3],nodi[5],3);

	Arco a8(nodi[4],nodi[5],1);
	Arco a9(nodi[4],nodi[6],2);
	Arco a10(nodi[4],nodi[7],7);

	Arco a11(nodi[5],nodi[10],10);
	Arco a12(nodi[5],nodi[6],2);
	
	Arco a13(nodi[6],nodi[7],1);
	Arco a14(nodi[6],nodi[9],7);

	Arco a15(nodi[7],nodi[9],7);
	Arco a16(nodi[7],nodi[8],1);

	Arco a17(nodi[8],nodi[9],1);
	Arco a18(nodi[8],nodi[10],2);
...
void test_reale(){
	...
	p=crea_problema(grafo,T,6,Nr_nodi);
...
void test_complesso(){
	...
	vector<Arco> grafo[nr];
	vector<Arco> T[nr];
	crea_grafo_alternativo(grafo,nodi);
	p=crea_problema(grafo,T,0,nr);
	cout<<"Albero di copertura iniziale-----"<<std::endl;
	stampa_grafo(p);
	simplessoRete(p);
